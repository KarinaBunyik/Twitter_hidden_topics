...
probs_name = 'probs_october_test.out'	--token-regex '[\p{L}\p{M}\p{P}]+'
...
'''
data_name = 'medium'
data_dir = 'malletTwitterLDA_medium'
model_name = data_name+'.mallet'
inference_name = 'inferencer_'+data_name+'.mallet'
inference_out_name = 'inference_'+data_name+'.out'
evaluator_name = 'eval_'+data_name+'.mallet'
probs_name = 'probs_'+data_name+'.out'
doc_probs_name = 'doc_probs_'+data_name+'.out'
topic_no = '10'
topic_word_no = '30'
iteration_no = '300'
topic_key_name = 'topic-keys-LDA-'+data_name+'.txt'
doc_topic_name = 'doc-topics-LDA-'+data_name+'.txt'
model_name_train = data_name+'_train'
model_name_test = data_name+'_test'
...
model_name_train_wpath = internal_path+model_name_train
model_name_test_wpath = internal_path+model_name_test
...
def commandString():
	command_string=(script_name_wpath+' '+
				...
				model_name_train_wpath+' '+
				model_name_test_wpath)
