...
model_name = 'medium.mallet'
inference_name = 'inferencer_medium.mallet'
inference_out_name = 'inference_medium.out'
evaluator_name = 'eval_medium.mallet'
probs_name = 'probs_medium.out'
doc_probs_name = 'doc_probs_medium.out'
topic_no = '30'
topic_word_no = '10'
iteration_no = '1000'
topic_key_name = 'topic-keys-LDA-medium.txt'
doc_topic_name = 'doc-topics-LDA-medium.txt'
